...
@dataclass
class QwenGateway(ILLMProviderGateway):
	"""Qwen (DashScope) — OpenAI-compatible API."""

	provider: ClassVar[LLMProvider] = LLMProvider.QWEN
	...
	async def generate(
		...
		if finish_reason == "content_filter":
			raise ContentSafetyException(message="Qwen filtered the response", details={})
