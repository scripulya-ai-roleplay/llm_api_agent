...
class AgentService(IAgentService):
	...
	async def handle(self, request: LLMRequest, on_token=None, on_thinking=None) -> UserMessageDTO:
		...
		return await service.generate(request, on_token=on_token, on_thinking=on_thinking)
